      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Sign in to continue to Larismanis
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium"
          >
            {isLoading ? (
